-- Retrait des condensés d'identité — second temps de l'identification par
-- e-mail seul, livrée en v1.10.0.
--
-- v1.10.0 a cessé de lire les condensés et écrit encore `identityDigest` à la
-- création d'une fiche. Cette migration ne peut donc partir qu'une fois v1.10.0
-- en production, ce qui est le cas : plus aucun code servi ne lit ces colonnes.
--
-- Une adresse ne désigne qu'une personne : d'où l'index unique ci-dessous, et la
-- fusion préalable des fiches qui partagent une adresse.
--
