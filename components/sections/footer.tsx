            ...
            <div className="flex gap-5">
              {socials.map(social => (
                <Link
                  ...
                  className="flex size-11 items-center justify-center rounded-full bg-background text-muted-foreground shadow-sm transition-colors hover:bg-rose-50 hover:text-rose-500"
                >
