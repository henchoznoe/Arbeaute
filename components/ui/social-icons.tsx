...
/**
 * Les deux seuls logos de marque du site, en SVG inline.
 *
 * Ils venaient de `@fortawesome/react-fontawesome`, dont le moteur
 * (`fontawesome-svg-core`, ~150 Ko avant minification) était chargé sur
 * chaque page pour dessiner ces deux icônes. Les tracés sont repris tels
 * quels de Font Awesome Free 7 (CC BY 4.0), le rendu est donc identique.
 */
