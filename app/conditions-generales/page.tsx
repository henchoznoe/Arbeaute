...
const TermsPage = () => (
  ...
  >
    <section>
      <h2>Objet</h2>
      <p>
        Les présentes conditions s’appliquent à toute réservation prise en ligne
        sur {contact.website.replace('https://', '')} ou directement auprès de{' '}
    ...
    <section>
      ...
      <p>
        ...
        moment de la réservation ; le règlement s’effectue sur place, à l’issue
        de la prestation.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        <strong>{CUSTOMER_CHANGE_CUTOFF_LABEL}</strong> avant l’heure du
    ...
    <section>
      ...
      <p>
        Certaines prestations (notamment le microblading et certains traitements
        laser) nécessitent la lecture et la signature préalable d’un formulaire
        de consentement, à imprimer et apporter le jour du rendez-vous. Ce
        document est indiqué lors de la réservation lorsqu’il est requis. Le
        rendez-vous peut être refusé sur place si ce formulaire n’est pas
        complété.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        Les présentes conditions sont soumises au droit suisse. En cas de litige
        et à défaut d’accord amiable, les tribunaux du canton de Fribourg sont
        seuls compétents.
      </p>
    </section>
  </LegalLayout>
